...
### [Build Stats Panel](complete/build%20stats%20panel)
Displays comprehensive build statistics including total material costs, installation costs, extras, total build cost, items produced, and cost per item.

### [Button Panel](complete/button%20panel)
Provides action buttons for managing job completion including marking as complete, passing build costs to parent jobs, marking for sale, and archiving jobs.

## Related Documentation

- [Edit Job Overview](edit%20job) - Complete job editing guide
- [Building Stage](building) - Previous stage in the lifecycle
- [Selling Stage](selling) - Next stage in the lifecycle
