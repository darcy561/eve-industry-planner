...
View all raw materials and resources required for the job, track child job relationships, and manage material acquisition planning.

### [Skills](planning/skills)
Check required skills for the job and compare them against your character's skill levels to ensure you can execute the job.

### [Archive Jobs](planning/archive%20jobs)
Review historical data from previously completed jobs of the same item type to inform your current planning decisions.

## Related Documentation

- [Edit Job Overview](edit%20job) - Complete job editing guide
- [Purchasing Stage](purchasing) - Next stage in the lifecycle
- [Blueprint Library](../blueprint%20library) - Managing your blueprint collection
