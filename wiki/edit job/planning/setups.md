...
#### Manufacturing Jobs
For manufacturing planner jobs, each card displays:
...
For reaction planner jobs, cards display:
...
These fields only appear for manufacturing planner jobs.
...
- Field: Dropdown select
- Availability: Only visible to logged-in users
...
- [Custom Structures](../settings/custom%20structures) — Configuring custom structures