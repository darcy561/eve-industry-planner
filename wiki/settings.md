...
5. **[Reprocessing Settings](settings/reprocessing)** - Set default reprocessing character preferences

## Quick Navigation

- [Layout Settings](settings/layout) - Enable/disable help cards and compact view
- [Job Settings](settings/job) - Default markets, asset locations, and job preferences
- [Custom Structures](settings/custom%20structures) - Add and manage custom structures
- [Blueprint Settings](settings/blueprint) - Material efficiency and job recalculation settings
- [Reprocessing Settings](settings/reprocessing) - Default reprocessing character selection

---

*All settings are automatically saved to your account and synced across devices.*
