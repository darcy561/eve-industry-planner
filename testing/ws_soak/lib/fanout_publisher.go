...
func buildLiveJob(rng *rand.Rand, snap liveSnapshot, kind fanoutMsgKind, docID, collection string, seq int) (fanoutJob, bool) {
	...
	case fanoutMsgAccount:
		...
		return fanoutJob{
			...
			TenantString:   models.AccountOwner(acct).Key(),
			AccountID:      acct,
	...
	case fanoutMsgCorpFull:
		...
		return fanoutJob{
			...
			DocID:          docID,
			Collection:     collection,
			TenantString:   models.Owner{Kind: models.OwnerCorporation, ID: CorporationRef(corpID)}.Key(),
	...
	case fanoutMsgAllianceFull:
		...
		return fanoutJob{
			...
			DocID:          docID,
			Collection:     collection,
			TenantString:   models.Owner{Kind: models.OwnerAlliance, ID: AllianceRef(allID)}.Key(),
