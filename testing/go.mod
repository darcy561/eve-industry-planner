module eve-industry-planner/testing

go 1.27.0

require (
	eve-industry-planner v0.0.0
...
require (
	...
	github.com/getsentry/sentry-go/otel v0.48.0 // indirect
	github.com/getsentry/sentry-go/otel/otlp v0.48.0 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20260731133940-c4725f2810a9 // indirect
	...
	go.opentelemetry.io/otel/sdk/metric v1.44.1-0.20260625150014-c84013202f01 // indirect
...
replace eve-industry-planner => ../services
