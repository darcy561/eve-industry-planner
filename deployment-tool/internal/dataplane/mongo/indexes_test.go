...
func TestIndexSpecsCoverExpected(t *testing.T) {
	...
	want := map[string]bool{
		...
		"account_job_documents.ajd_meta_accountID_apiOrders_1":                         true,
		"account_job_documents.ajd_meta_accountID_apiJobs_1":                           true,
		"account_job_documents.ajd_meta_accountID_apiTransactions_1":                   true,
