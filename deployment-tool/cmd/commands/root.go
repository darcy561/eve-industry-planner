// Package commands holds deployment-tool Cobra commands (one file per command).
//
// Convention: one file per verb; init() registers on rootCmd.
// Scaffold: cd deployment-tool/cmd/commands && go run github.com/spf13/cobra-cli@v1.3.0 add <name>
package commands
...
Source lives in deployment-tool/; command prefix is eip.
