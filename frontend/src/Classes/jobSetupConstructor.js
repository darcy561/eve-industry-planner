...
class Setup {
   ...
   * @param {string} [setupInstructions.appliedRequirementID] - Applied requirement ID
  ...
  constructor(setupInstructions) {
    ...
    this.alternativeSystemIndexValue =
      setupInstructions?.alternativeSystemIndexValue || null;
   ...
   * - Finds the selected character or falls back to parent user
