...
/** Live planner jobs — Mongo `user_job_documents`; pair with `useDocumentLock(USER_JOBS_COLLECTION, jobID, enabled)`. */
export const USER_JOBS_COLLECTION = "user_job_documents";
