...
How the SPA reads the static EVE data files it downloads and caches — currently the item records and
the buildable-item search index, through their owners under
