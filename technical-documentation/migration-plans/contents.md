...
| Realtime delivery shape (one internal shape every inbound path converts to, a family-keyed table saying how a family is delivered, one walk replacing six fan-out functions, and the vocabulary covering every family addressed to an audience; **stages landed, promotion drafted and waiting on realtime message routing**) | [realtime-delivery-shape/contents.md](./realtime-delivery-shape/contents.md) |
