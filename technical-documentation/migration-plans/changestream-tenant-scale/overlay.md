# Overlays — changestream tenant scale

Per-phase land notes for [plan.md](./plan.md). **Not live SoT.** On overlap with live docs, these overlays win until promote.
...
| D — Auto-detect dedicated Watch | open (optional) | [overlays/d-auto-detect.md](./overlays/d-auto-detect.md) |
