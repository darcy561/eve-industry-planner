...
Stage E's revocation path has landed. What it leaves is the join direction — a new member waits for
their next grant derivation — and two trade-offs Stage I should revisit: the announcement is
