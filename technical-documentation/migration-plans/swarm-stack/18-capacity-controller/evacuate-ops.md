# Evacuate / pin / cordon ops (#21)

**Roadmap:** #21 / #18  
**Phase:** C **done** 2026-08-09 (pin/move follow-on)
...
- Evacuate / automatic Apply: gated by **`capacity_controller_managed`** (template default true). Operator `eip capacity evacuate` is a one-shot WS scale-in. Pin/move not landed. Census parked.
...
Pin/move deferred until evacuate works. Hosted id census not required to evacuate a known container_id.
...
- Pin / move tenant: **follow-on** (not Phase C).
