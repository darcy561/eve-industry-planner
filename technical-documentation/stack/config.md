...
Live SoT for non-secret operator YAML. Secrets → [secrets.md](./secrets.md). Apply verb → [verbs.md](../deployment/deployment-tool/cli/verbs.md) (`eip sync`). Networks → [network.md](./network.md). Traefik routes → [traefik.md](./traefik.md).
