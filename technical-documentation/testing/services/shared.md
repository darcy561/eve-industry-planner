...
| Other focused | `instanceid` replica priority/sanitize; `swarmsecret` env-over-file; Mongo/Redis URL API fallback; process `APP_VERSION` helpers; dependency unavailable-error detection; small firebaseadmin / evesso helpers |
