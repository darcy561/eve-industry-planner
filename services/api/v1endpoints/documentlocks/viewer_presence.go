...
func (h *Handlers) handleViewerArrived(w http.ResponseWriter, r *http.Request) {
	...
	documentlock.HandleViewerArrivedIngress(hc.Ctx, h.LockDeps(), hc.Owner, hc.SessionID, hc.Collection, hc.DocID)
...
func (h *Handlers) handleViewerDeparted(w http.ResponseWriter, r *http.Request) {
	...
	documentlock.HandleViewerDepartedIngress(hc.Ctx, h.LockDeps(), hc.Owner, hc.SessionID, hc.Collection, hc.DocID)
