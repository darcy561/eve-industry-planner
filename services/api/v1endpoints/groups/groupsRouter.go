...
func (h *Handlers) Router(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		helper.RespondEndpointError(w, r, http.StatusNotFound, "Not found", "groups route not found", "groups_not_found", "groups", nil, map[string]any{"path": path})
	}
}
